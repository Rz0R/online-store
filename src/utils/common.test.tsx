import { IMAGESWITHSIZE, IMAGESWITHSIZEWITHOUTDUPLICATE } from '../mocks/data';
import {
...
describe('Checks common functions', () => {
  ...
  test('getImagesWithoutDuplicate return unique values', () => {
    expect(getImagesWithoutDuplicate(IMAGESWITHSIZE)).toEqual(IMAGESWITHSIZEWITHOUTDUPLICATE);
  });
});
